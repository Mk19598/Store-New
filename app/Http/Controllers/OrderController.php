...
class OrderController extends Controller
{
    ...
    public function dukkan_orders_update($days_limit){
        try {
            ...
            $subOneDay = $now->subDays($days_limit)->toDateString();
                ...
                if ($response->successful()) {
                    ...
                    foreach ($orders['results'] as $key => $order) {
                        ...
                        foreach ($order_response['data']['products'] as $key => $orders_products) {
                            ...
                            $InventoryManagement =  InventoryManagement::where('sku',$skuCode)->first();
                            ...
                            DukaanOrderProduct::create([ 
                                ...
                                "sku"          =>  $skuCode , 
                                "barcode"      => $InventoryManagement->barcode ?? null,
                                "barcode_image"      => $InventoryManagement->barcode_image ?? null,
