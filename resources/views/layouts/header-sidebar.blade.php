                    ...
                    <li class="nav-item has-submenu">
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                ...
                                <li class="submenu-item"><a class="submenu-link" href="{{ route('orders.dukkan_orders_update', 1) }}">{{ __('Dukkan Update')}}</a></li>
                                <li class="submenu-item"><a class="submenu-link" href="{{ route('orders.woocommerce_orders_update',1) }}">{{ __('Woocommerce Update')}}</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item has-submenu">
                      ...
                      <li class="nav-item has-submenu">
                        ...
                        <div id="submenu-10" class="collapse submenu submenu-6" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link" href="{{ route('logs.crons') }}">{{ ucwords(__('Cron Logs')) }}</a></li>
                            </ul>   
                        </div>
                    </li>
