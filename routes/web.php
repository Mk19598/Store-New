...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'orders' ], function () {
        ...
        Route::get('razorpay/verify-payment/{paymentId}', [App\Http\Controllers\OrderController::class, 'verifyPaymentrazorpay']);
        Route::get('phonepe/verify-payment/{paymentId}', [App\Http\Controllers\OrderController::class, 'verifyPaymentphonepe']);
