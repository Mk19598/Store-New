        ...
        $ContentTemplate = [
                        [   'template_type' => 'Order Rejected', 
                            ...
                            'template_content' => 'Dear {Name},&nbsp;
                                            ...
                                            Your Order Amount was {total} &nbsp; *Order ID:*: {orderno} &nbsp;.
                                            Thank you.&nbsp;',
                        ...
                        [   'template_type' => 'Order Cancelled by Customer', 
                            ...
                            'template_content' => 'Dear {Name},&nbsp;
                                             ...
                                             Please reply to this chat, if you need any further clarification &nbsp;*Order ID:* {orderno}&nbsp;.
                                             Thank you.&nbsp;',
                        ...
                        [   'template_type' => 'Order Shipped', 
                            ...
                            'template_content' => 'Dear {Name},
                            Your Order is Now SHIPPED. &nbsp; *Order ID:* &nbsp;{orderno} &nbsp;Wait for your Order to Arrive in the Next Few Days&nbsp;
                             Thank you.&nbsp;',
                            'role_type' => 'General Content Triggers' ,
                            'created_at' => Carbon::now(),
                            'updated_at' => null,
                        ...
                        [   'template_type' => 'Cart Abandonment', 
                            ...
                            'template_content' => "Dear {Name},
                                Your Cart misses you. We've saved your items for a limited time. Checkout now&nbsp;
                                Thank you.&nbsp ;",
                            'role_type' => 'General Content Triggers' ,
                            'created_at' => Carbon::now(),
                            'updated_at' => null,
                        ...
                        [   'template_type' => 'New Order Received', 
                            ...
                            'template_content' => "Dear {Name},
                                Thank you for shoping at StandardOil Online Store and purchasing with us. Your Bill Amount is *{total}* &nbsp;*Order ID:* {orderno} &nbsp;Thank you. Please visit again.&nbsp;*Standard Oil*
                                ",
                            'role_type' => 'General Content Triggers' ,
                            'created_at' => Carbon::now(),
                            'updated_at' => null,
